            ...
            <div>
              ...
              <Row style={{backgroundColor:"#F8F8F8"}}>
                ...
                <Col xs={10} sm={10} md={8}>
                  <p style={{marginTop:150}} class ="programheaderRed"> <span> Ranking Methodology </span></p>
                  <p style={{fontSize:22, textAlign:"center", marginBottom:100}}>You might be wondering how we came up with 20-20's rankings. For our programs,
                  we examined graduate school attendence data to determine which programs are the most popular.
                  For our 20 schools in each program, we examine multiple factors such as school prestige,
                  program employment information, curriculum, and admission standards.</p>
                </Col>
